...
- API version: 2023.8.1-228047600
- Package version: 2023.8.1-228047600
...
*TrakerApi.UserControllerApi* | [**login**](docs/UserControllerApi.md#login) | **POST** /auth/user/login | 
*TrakerApi.UserControllerApi* | [**session**](docs/UserControllerApi.md#session) | **GET** /auth/user/session | 
*TrakerApi.UserControllerApi* | [**signup**](docs/UserControllerApi.md#signup) | **POST** /auth/user | 
...
## Documentation for Models
 ...
 - [TrakerApi.ListResponseAlertResponseDto](docs/ListResponseAlertResponseDto.md)
 - [TrakerApi.ListResponseNotificationResponseDto](docs/ListResponseNotificationResponseDto.md)
 - [TrakerApi.ListResponseVehicleResponseDto](docs/ListResponseVehicleResponseDto.md)
