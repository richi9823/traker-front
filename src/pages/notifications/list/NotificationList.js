...
import { getAllNotifications, readNotification } from '../../../actions/notification';
...
class NotificationList extends React.Component {
  ...
  componentDidMount() {
      this.props.dispatch(getAllNotifications(null, null, null, 1,5, null)).then((response) => {
  ...
  componentDidUpdate(prevProps, { queryParams: prevQueryParams }) {
    ...
    if (!isEqual(prevQueryParams, queryParams)) {
      this.props.dispatch(getAllNotifications(null, null, null, paginationOptions.page, paginationOptions.sizePerPage, null)).then((response) => {
        this.setState((prev) => (
          {
            paginationOptions:{
            ...prev.paginationOptions,
  ...
  doRemove = () => {
    ...
    this.props.dispatch(readNotification(deleteItem.id)).then(()=>{
      this.props.dispatch(getAllNotifications(null, null, null, paginationOptions.page, paginationOptions.sizePerPage, null)).then((response) => {
        this.setState((prev) => (
          {
            showDeleteModal:false,
